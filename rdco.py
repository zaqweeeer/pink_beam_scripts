...
def parse_args():
    parser = argparse.ArgumentParser(description='', usage='./rdco.py [-i k.dat -s spectrum -o rdco.dat]')
    parser.add_argument('-i', '--input', type=str, default='k.dat', help="input file, default = k.dat")
    parser.add_argument('-s', '--spectrum', type=str, default='spectrum', help="spectrum file, default = spectrum")
    parser.add_argument('-o', '--output', type=str, default='rdco.dat', help="output file, default = rdco.dat")
...
if __name__ == '__main__':
    ...
    for lim in lims: 
        ...
        try: 
            ...
            intensity.append(np.interp([k10,], sk, si, left=si[0])) 
        except: 
            intensity.append(np.array([1,])) 
